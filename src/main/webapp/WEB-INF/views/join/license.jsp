...
<script type="text/javascript" src="/js/join/license.js?ver=20231119"></script>
</head>
								...
								<div class="inner">
									...
									<div class="info_box">
										...
										<div id="license-no" class="form_row ">
											...
											<input id="number" maxlength="12" type="text" placeholder="면허번호를 입력해주세요" value="">
										...
										<div id="issue-date" class="form_row ">
											...
											<input id="isDate" type="tel" placeholder="예) 20210101" value="">
										...
										<div id="expiration-date" class="form_row ">
											...
											<input id="exDate" type="tel" placeholder="예) 20251231" value="">
							...
							<div class="sub_cont mt12">
								<div class="inner">
									...
									<div id="view2-modal" style="display: none;" class="layerPopup open bg_white small">
										<jsp:include page="../join/views/license-view1.jsp" />
									</div>
								</div>
							</div>
							<div class="btn_group multy">
									
								<form action="paymentReg.do" method="Post">	
